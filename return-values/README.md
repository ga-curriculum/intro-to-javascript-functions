...
Remember, when a function runs, it executes its statements and then returns a value. We can use assignment (the `=` operator) to assign a functions return value to a variable, just like any other value. 
